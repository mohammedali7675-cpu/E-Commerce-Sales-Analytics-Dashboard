...
SELECT 
    ...
    o.Quantity, 
    o.Discount,
    -- Formula 1: without discount
    ROUND((o.Sales - (p.Cost_Price * o.Quantity))::NUMERIC, 2) AS expected_no_discount,
    -- Formula 2: with discount applied
    ROUND(((o.Sales * (1 - o.Discount)) - (p.Cost_Price * o.Quantity))::NUMERIC, 2) AS expected_with_discount
...
SELECT 
    ...
    p.Cost_Price,
    o.Shipping_Mode,
    -- what our formula gives
    ROUND((o.Sales - (p.Cost_Price * o.Quantity))::NUMERIC, 2) AS expected_profit,
    -- the gap between actual and expected
    ROUND((o.Profit - (o.Sales - (p.Cost_Price * o.Quantity)))::NUMERIC, 2) AS gap
FROM "e_commerce".orders o
JOIN "e_commerce".products p ON o.Product_ID = p.Product_ID
LIMIT 20;
